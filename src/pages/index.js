  ...
  <div>
    ...
    <div className="work_list">
      ...
      副業・転職のキャリアSNS「YOUTRUST」のサービスデザインリニューアルを担当しました。
        <ul>
          <li><a href="https://twitter.com/cooktsuji/status/1289009047648100353">Twitter Promotion</a></li>
          <li><a href="https://https://youtrust.jp/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://cookpad-kitchen.com/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://tabedori.jp/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://cookpad.com">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://sdevtalks.org/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://sharefull.com/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ロゴ・LPのデザインを担当しました。
        <ul>
          <li><a href="https://fooddatabank.net/">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://herp.cloud/index.html">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://info.cookpad.com/pr/news/press_2017_1129">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://my-best.com">Link to Service</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          <li><a href="https://note.com/astrotom/n/n674777b04f39">Link to Blog</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          ...
          <li><a href="https://tigerspike.connpass.com/event/82821/">Link to Event Page</a></li>
        </ul>
      </p>
    </div>
    ...
    <div className="work_list">
      ...
      <p className="works_description">
        ...
        <ul>
          ...
          <li><a href="https://techconf.cookpad.com/2018/">Link to Event Page</a></li>
        </ul>
      </p>
    </div>
